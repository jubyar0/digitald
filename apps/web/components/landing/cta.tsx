                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                            <Button asChild size="lg" className="bg-blue-500 hover:bg-blue-600 text-white px-8 h-14 text-lg">
                                <Link href="/register">Create Free Account</Link>
                            </Button>
                            <Button asChild variant="outline" size="lg" className="border-gray-600 text-white hover:bg-white/10 hover:text-white px-8 h-14 text-lg bg-transparent">
