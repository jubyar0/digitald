...
export default async function CategoryProductsPage({
    ...
    const productsData = await getProductsByCategory(params.category, page, 12);
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <ProductSort sortBy={sortBy} baseUrl={`/${params.category}`} />
                    </div>
                </div>
                    ...
                    <>
                        ...
                        {productsData.totalPages > 1 && (
                            <div className="mt-12 flex justify-center gap-2">
                                {page > 1 && (
                                    <Link
                                        href={`/${params.category}?page=${page - 1}${sortBy !== "newest" ? `&sort=${sortBy}` : ""}`}
                                ...
                                <div className="flex items-center gap-2">
                                    {Array.from({ length: Math.min(5, productsData.totalPages) }, (_, i) => {
                                        ...
                                        return (
                                            <Link
                                                key={pageNum}
                                                href={`/${params.category}?page=${pageNum}${sortBy !== "newest" ? `&sort=${sortBy}` : ""}`}
