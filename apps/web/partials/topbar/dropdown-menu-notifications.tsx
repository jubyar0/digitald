  ...
  return (
    <Sheet>
      ...
      <SheetContent className="p-0 sm:max-w-[500px]">
        ...
        <div className="grow p-0 flex flex-col overflow-hidden">
          <Tabs defaultValue="all" className="w-full relative flex flex-col h-full">
            ...
            {/* Team Tab */}
            <TabsContent value="team" className="mt-0 flex-1 overflow-y-auto">
              <div className="flex flex-col gap-5">
                <Item7 />
                <Item5
            ...
            {/* Following Tab */}
            <TabsContent value="following" className="mt-0 flex-1 overflow-y-auto">
              <div className="flex flex-col gap-5">
                <Item9 />
                <Item15 />
                <Item16 />
